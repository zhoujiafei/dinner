...
class UserLogin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, token,user_id,login_time,visit_client', 'required'),
			array('user_id, username, token, login_time, ip, visit_client', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('visit_client',$this->visit_client);
