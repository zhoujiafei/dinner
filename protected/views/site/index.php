...
<div id="right">
	...
	<a href="javascript:alert('敬请期待');" target="_blank" id="androidAppDownload" class="mt10" style="display: block;">
	    <img src="<?php echo Yii::app()->baseUrl;?>/assets/images/front/appdown.png" width="272" height="63" alt="Adroid APP客户端"></a>
